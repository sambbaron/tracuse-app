...
class UiObjectModel(BaseModel):
    ...
    ui_arrangement_type = models.ForeignKey("ui.UiArrangementType",
                                            db_column="ui_arrangement_type_id",
                                            null=True, blank=True
                                            )
    ui_formatting_type = models.ForeignKey("ui.UiFormattingType",
...
class UiArrangementType(EntityModel):
    ...
    Attributes:
        ...
        entity_name: technical attribute name
            Must correspond to UiArrangement* model
...
class UiArrangementFlexbox(UiOptionModel):
    ...
    class Meta(UiOptionModel.Meta):
        db_table = "ui_arrangement_flexbox"
        verbose_name = "Arrangement Flexbox Option"

    ui_arrangement_flexbox_id = models.AutoField(primary_key=True)
