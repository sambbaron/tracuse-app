...
class ElementDatumObjectSerializer(Serializer):
    ...
    def serial_default(self):
        ...
        output = {
            "element_datum_object_id": self.obj.element_datum_object_id,
    ...
    def serial_related(self):
        output = self.serial_default()
        output["element_datum_type"] = self.obj.element_datum_type.element_datum_type_id
        output["element_type"] = self.obj.element_type.element_type_id
