...
class ElementTypeAdmin(EntityMixinAdmin):
    ...
    list_display = EntityMixinAdmin.list_display + ("element_data_type", "str_expression",)
    list_editable = EntityMixinAdmin.list_editable + ("element_data_type", "str_expression",)
