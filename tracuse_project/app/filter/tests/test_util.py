...
class TestRunFilter(TestCase):
    ...
    def test_filter_set_user1(self):
        ...
        test_filter = utils.run_filter_from_model(**self.test.filter_set_user1)
        self.assertEqual(22, len(test_filter))

    def test_filter_set_group1(self):
        """Test single group rule"""
        test_filter = utils.run_filter_from_model(**self.test.filter_set_group1)
    ...
    def test_filter_set_group2(self):
        ...
        test_filter = utils.run_filter_from_model(**self.test.filter_set_group2)
    ...
    def test_filter_set_type1(self):
        ...
        test_filter = utils.run_filter_from_model(**self.test.filter_set_type1)
    ...
    def test_filter_set_type2(self):
        ...
        test_filter = utils.run_filter_from_model(**self.test.filter_set_type2)
    ...
    def test_filter_set_association1(self):
        ...
        test_filter = utils.run_filter_from_model(**self.test.filter_set_association1)
    ...
    def test_filter_set_association2(self):
        ...
        test_filter = utils.run_filter_from_model(**self.test.filter_set_association2)
    ...
    def test_filter_set_element1(self):
        ...
        test_filter = utils.run_filter_from_model(**self.test.filter_set_element1)
        self.assertEqual(3, len(test_filter))
        self.assertTrue({6, 7, 11}.issubset(test_filter))
 
    def test_filter_set_element2(self):
        """Test single element rule for number"""
        test_filter = utils.run_filter_from_model(**self.test.filter_set_element2)
    ...
    def test_filter_set_element3(self):
        ...
        test_filter = utils.run_filter_from_model(**self.test.filter_set_element3)
        self.assertEqual(1, len(test_filter))
        self.assertEqual({13}, test_filter)

    def test_filter_set_data_type1(self):
        """Test single data type rule for string"""
        test_filter = utils.run_filter_from_model(**self.test.filter_set_data_type1)
        self.assertEqual(2, len(test_filter))
        self.assertEqual({12, 25}, test_filter)

    def test_filter_from_dict(self):
        """Test complex filter set using raw dictionary"""
        test_filter = utils.run_filter_from_dict(**self.test.filter_set_dict1)
        self.assertEqual(2, len(test_filter))
        self.assertEqual({12, 13}, test_filter)